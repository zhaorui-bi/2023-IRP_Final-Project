...
class Adafruit_I2C(object):
  ...
  def write16(self, reg, value):
    ...
    try:
      ...
      if self.debug:
        print("I2C: Wrote 0x{} to register pair 0x{},0x{}".format(value, reg, reg+1))
    except IOError as err:
      return self.errMsg()
  ...
  def writeRaw8(self, value):
    ...
    try:
      ...
      if self.debug:
        print("I2C: Wrote 0x{}".format(value))
    except IOError as err:
      return self.errMsg()
  ...
  def readList(self, reg, length):
    ...
    try:
      ...
      if self.debug:
        print ("I2C: Device 0x{} returned the following from reg 0x{}".format(self.address, reg))
        print(results)
      return results
    except IOError as err:
      return self.errMsg()
